      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm font-medium mt-1">
            Registry of all historical and active sequences
          </p>
        </div>
        <button
                ...
                filteredOrders.map((order) => (
                  ...
                  >
                    <td className="py-4 px-6">
                      <p className="text-xs font-bold text-gray-900 group-hover:text-primary-600 transition-colors uppercase tracking-tight">
                        {order.product_name}
                      </p>
                      <p className="text-[10px] font-mono text-gray-400 mt-0.5 whitespace-nowrap">
