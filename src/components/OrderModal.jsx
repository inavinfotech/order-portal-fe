...
const OrderModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    try {
      ...
      if (res.data.length > 0) {
        ...
        setOrderForm((prev) => {
          if (
            !prev.application_id ||
            !res.data.find((a) => a.id === prev.application_id)
          ) {
  ...
  const handleInitiateOrder = async (e) => {
    ...
    try {
      ...
      const summaryProductName = orderForm.items
        .map((i) => i.product_name)
        .join(", ");
      const truncatedName =
        summaryProductName.length > 100
          ? summaryProductName.substring(0, 97) + "..."
          : summaryProductName;
      ...
      const msg =
        err.response?.data?.detail || err.message || "Failed to initiate order";
      alert(msg);
    } finally {
        ...
        {showSuccess ? (
          <div className="p-12 text-center animate-in fade-in zoom-in duration-500">
            ...
            <p className="text-gray-500 font-medium">
              The fulfillment sequence has been triggered for{" "}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setOrderForm({ ...orderForm, user_id: e.target.value })
                      }
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {orderForm.items.map((item, index) => (
                    <div
                      key={item.id}
                      className="bg-gray-50/50 border border-gray-100 rounded-2xl p-4 space-y-4 animate-in slide-in-from-left-2 duration-200"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-gray-100 rounded-xl pl-11 pr-4 py-2.5 text-xs font-semibold text-gray-900 focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all font-mono"
                            />
                          </div>
                        </div>
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-gray-100 rounded-xl pl-11 pr-4 py-2.5 text-xs font-semibold text-gray-900 focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all"
                            />
                          </div>
                        </div>
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className="w-full bg-white border border-gray-100 rounded-xl px-4 py-2.5 text-xs font-semibold text-gray-900 focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all"
                          />
                        </div>
                      </div>
